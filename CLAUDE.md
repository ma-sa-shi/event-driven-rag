...
- The architecture and CI/CD diagrams in `README.md` are exported from `docs/diagrams/blueprint.drawio`; edit that file and re-export the SVGs when the architecture changes.
